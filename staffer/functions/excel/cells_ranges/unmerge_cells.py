"""Unmerge cells in Excel worksheet function."""
...
def unmerge_cells(working_directory, filepath, sheet_name, start_cell, end_cell):
    """Unmerge a range of cells in Excel worksheet.
    ...
    try:
        ...
        if not is_merged:
            return f"Error: Range {range_string} is not merged"
        ...
        return f"Range {range_string} unmerged successfully"
...
schema_unmerge_cells = types.FunctionDeclaration(
    name="unmerge_cells",
    description="Unmerge a range of cells in Excel worksheet",
    parameters=types.Schema(
        ...
        properties={
            ...
            "sheet_name": types.Schema(
                type=types.Type.STRING,
                description="Name of worksheet containing cells to unmerge",
            ),
            "start_cell": types.Schema(
                type=types.Type.STRING,
                description="Top-left cell of range to unmerge (e.g., 'A1')",
            ),
            "end_cell": types.Schema(
                type=types.Type.STRING,
                description="Bottom-right cell of range to unmerge (e.g., 'B2')",
            ),
        },
