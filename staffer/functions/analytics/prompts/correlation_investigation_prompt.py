...
def correlation_investigation(working_directory: str, dataset_name: str) -> str:
...
schema_correlation_investigation = types.FunctionDeclaration(
    name="correlation_investigation",
    description="Guide correlation analysis workflow",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "dataset_name": types.Schema(
                type=types.Type.STRING,
                description="Name of the dataset to investigate for correlations",
            ),
        },
