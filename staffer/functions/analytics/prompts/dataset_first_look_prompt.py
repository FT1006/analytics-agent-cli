...
def dataset_first_look(working_directory: str, dataset_name: str) -> str:
...
schema_dataset_first_look = types.FunctionDeclaration(
    name="dataset_first_look",
    description="Adaptive first-look analysis based on dataset characteristics",
