...
def data_quality_assessment(working_directory: str, dataset_name: str) -> str:
...
schema_data_quality_assessment = types.FunctionDeclaration(
    name="data_quality_assessment",
    description="Guide systematic data quality review",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "dataset_name": types.Schema(
                type=types.Type.STRING,
                description="Name of the dataset to assess for data quality",
            ),
        },
