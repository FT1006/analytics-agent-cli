"""List analytics assets prompt implementation."""

from google.genai import types


def list_analytics_assets(working_directory: str) -> str:
    """Return a comprehensive list of all Analytic Agent CLI capabilities."""
    
    return """# 🚀 Analytic Agent CLI Assets
...
Tool versions of resources for comprehensive data access:
...
schema_list_analytics_assets = types.FunctionDeclaration(
    name="list_analytics_assets",
    description="Return a comprehensive list of all Analytic Agent CLI capabilities and available tools",
