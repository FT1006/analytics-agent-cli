...
schema_merge_datasets = types.FunctionDeclaration(
    name="merge_datasets",
    description="Join datasets on common keys",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "dataset_configs": types.Schema(
                type=types.Type.ARRAY,
                description="List of dataset configurations to merge",
                items=types.Schema(type=types.Type.OBJECT),
            ),
            "join_strategy": types.Schema(
                type=types.Type.STRING,
                description="Join strategy (inner, left, right, outer)",
            ),
        },
        required=["dataset_configs"],
    ),
)