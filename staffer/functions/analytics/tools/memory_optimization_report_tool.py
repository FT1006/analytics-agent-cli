...
def memory_optimization_report(working_directory: str, dataset_name: str) -> dict:
...
schema_memory_optimization_report = types.FunctionDeclaration(
    name="memory_optimization_report",
    description="Analyze memory usage and suggest optimizations",
    parameters=types.Schema(
        type=types.Type.OBJECT,
        properties={
            "dataset_name": types.Schema(
                type=types.Type.STRING,
                description="Name of the dataset to analyze for memory optimization",
            ),
        },
