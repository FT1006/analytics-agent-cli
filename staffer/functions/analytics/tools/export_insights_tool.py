...
def export_insights(working_directory: str, dataset_name: str, format: str = "json", include_charts: bool = False) -> dict:
...
schema_export_insights = types.FunctionDeclaration(
    ...
    parameters=types.Schema(
        ...
        properties={
            "dataset_name": types.Schema(
                ...
                description="Name of the dataset to export insights for",
            ),
            "format": types.Schema(
                type=types.Type.STRING,
