...
schema_time_series_analysis = types.FunctionDeclaration(
    name="time_series_analysis",
    description="Temporal analysis when dates are detected",
    parameters=types.Schema(
        ...
        properties={
            ...
            "date_column": types.Schema(
                type=types.Type.STRING,
                description="Column containing date/time values",
            ),
            "value_column": types.Schema(
                type=types.Type.STRING,
                description="Column containing values to analyze over time",
            ),
            "frequency": types.Schema(
                type=types.Type.STRING,
                description="Frequency for time series aggregation (default: auto)",
            ),
        },
