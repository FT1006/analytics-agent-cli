...
def analyze_distributions(working_directory: str, dataset_name: str, column_name: str) -> dict:
...
schema_analyze_distributions = types.FunctionDeclaration(
    name="analyze_distributions",
    description="Analyze distribution of any column",
