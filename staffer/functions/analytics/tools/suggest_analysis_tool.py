...
def suggest_analysis(working_directory: str, dataset_name: str) -> dict:
...
schema_suggest_analysis = types.FunctionDeclaration(
    name="suggest_analysis",
    description="AI recommendations based on data characteristics",
